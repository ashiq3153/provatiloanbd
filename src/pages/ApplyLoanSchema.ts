...
export const getLoanSchema = (isBn: boolean) => z.object({
  ...
  workDuration: z.string().min(1, { message: isBn ? "কাজের মেয়াদ দিন" : "Enter work duration" }).optional(),
  monthlyIncome: z.string().min(1, { message: isBn ? "মাসিক আয় দিন" : "Enter monthly income" }).optional(),
  ...
  guardianIncome: z.string().min(1, { message: isBn ? "আয় দিন" : "Enter income" }).optional(),
