...
export const getCategories = (isBn: boolean, settings?: any) => [
  {
    ...
    reqDocs: isBn ? ["এনআইডি", "ছবি", "অফিস আইডি", "বেতনের প্রমাণপত্র"] : ["NID", "Photo", "Office ID", "Salary Certificate"],
  ...
  },
  {
    ...
    reqDocs: isBn ? ["এনআইডি", "ছবি", "ট্রেড লাইসেন্স", "ব্যাংক স্টেটমেন্ট"] : ["NID", "Photo", "Trade License", "Bank Statement"],
  ...
  },
  {
    ...
    reqDocs: isBn ? ["পাসপোর্ট/এনআইডি", "ভিসা কপি", "ওয়ার্ক পারমিট"] : ["Passport/NID", "Visa Copy", "Work Permit"],
  ...
  },
  {
    ...
    reqDocs: isBn ? ["স্টুডেন্ট আইডি", "ছবি", "অভিভাবকের এনআইডি ও আয়"] : ["Student ID", "Photo", "Guardian's NID & Income"],
  ...
  },
  {
    ...
    reqDocs: isBn ? ["এনআইডি", "ছবি", "জরুরি/মেডিকেল ডকুমেন্টস"] : ["NID", "Photo", "Medical/Emergency Docs"],
  ...
  },
  {
    ...
    reqDocs: isBn ? ["এনআইডি", "ছবি", "ট্রেড লাইসেন্স/প্রমাণপত্র"] : ["NID", "Photo", "Trade License/Proof"],
